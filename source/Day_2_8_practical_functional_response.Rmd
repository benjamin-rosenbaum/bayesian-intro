---
title: "2.8 Practical: nonlinear model - functional response"
...
$a$ descibes the slope of the curve in the origin, while the saturation (maximum feeding rate) is given by $\frac{1}{h}$.
